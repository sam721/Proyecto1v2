========================================================================
    APLICACIÓN DE CONSOLA: proyecto1grafica2v2 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación proyecto1grafica2v2.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación proyecto1grafica2v2.


proyecto1grafica2v2.vcxproj
...
proyecto1grafica2v2.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado proyecto1grafica2v2.pch y un archivo de tipos 
